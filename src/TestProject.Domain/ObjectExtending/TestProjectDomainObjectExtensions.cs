...
namespace TestProject.ObjectExtending
{
    public static class TestProjectDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the TestProjectEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
